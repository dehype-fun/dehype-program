...
import { PINATA_SECRET_API_KEY, PRIVATE_KEY } from "../constants";


const curveSeed = "CurveConfiguration"
const POOL_SEED_PREFIX = "liquidity_pool"
const LP_SEED_PREFIX = "LiqudityProvider"
const PINATA_GATEWAY_URL = process.env.PINATA_GATEWAY_URL || 'https://brown-active-unicorn-586.mypinata.cloud'
...
export const createToken = async (data: CoinInfo) => {
    ...
    try {
        ...
        console.log("Error in creating liquidity pool", error)
